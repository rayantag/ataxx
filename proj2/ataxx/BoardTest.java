...
public class BoardTest {
    ...
    public void myTest() {
        ...
        b.setBlock('c', '3');
        b.setBlock('d', '3');
        System.out.println("can BLUE move in starting position: "
                + b.canMove(BLUE));
        System.out.println(b.legalMove('a', '1', 'b', '1'));
        System.out.println(b.canMove(RED));
        String[] moves = {"a7-b7"};
        makeMoves(b, moves);
        System.out.println(b.canMove(BLUE));
        System.out.println(b.canMove(RED));
        String[] moves1 = {"a1-b1"};
        makeMoves(b, moves1);
        System.out.println(b.canMove(BLUE));
